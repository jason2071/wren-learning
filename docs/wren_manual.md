...
1. [ติดตั้ง + ตั้งค่า](#1)
2. [seed demo DB](#2)
3. [วงจร build / index / load — หัวใจ](#3)
4. [ถามข้อมูล (query)](#4)
5. [Memory](#5)
6. [เพิ่มตารางใหม่ end-to-end](#6)
7. [เพิ่มคำถามใหม่ (recipe + ทางลัด)](#7)
8. [instructions.md — กติกาธุรกิจ](#8)
9. [แก้ปัญหา (Troubleshooting)](#9)
10. [Cheat sheet — คำสั่งทั้งหมด](#10)
...
### 1.3 ⚠️ ทุกครั้งที่เปิด terminal ใหม่ ต้องทำ 3 อย่างนี้ก่อน
...
### 2.2 ตรวจว่า seed ถูก (sanity check)
...
<a id="3"></a>
## 3. วงจร build / index / load — หัวใจที่ต้องเข้าใจ
...
### 4.2 ดู SQL ที่ Wren แปลจริง (ไม่แตะ DB)
...
### 4.3 ดูว่า model มีคอลัมน์อะไรบ้าง
...
### 5.2 recall — distance หมายถึงอะไร
...
### 5.3 store vs load vs queries.yml — เลือกอันไหน
...
### 5.4 recall สวยๆ (อ่านง่าย) — function ใน ~/.zshrc
...
<a id="6"></a>
## 6. ตัวอย่างเต็ม — เพิ่มตารางใหม่ end-to-end
...
<a id="7"></a>
## 7. เพิ่มคำถามใหม่ (recipe + ทางลัด)
